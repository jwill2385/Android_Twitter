...
public class TwitterClient extends OAuthBaseClient {
	...
	//This command will push tweets to twitter
    public void publishTweet(String tweetContent, long status_id, JsonHttpResponseHandler handler) {
	...
	//This command will Retweet tweets to twitter
	...
	// This command will unRetweet tweet from twitter
	public void unretweetTweet(long id, JsonHttpResponseHandler handler) {
		String url = String.format("statuses/unretweet/%d.json", id);
		String apiUrl = getApiUrl(url);
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("id", id);
	...
	//This command will Favorite tweets to twitter
	...
	//This command will get list of followers for specific user
	...
	//This command will get list of ppl following a specific user
